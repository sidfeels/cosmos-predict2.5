...
from cosmos_predict2._src.predict2.interactive.configs.callbacks import (
    register_callbacks as register_callbacks_interactive,
)
...
from cosmos_predict2._src.predict2.interactive.configs.net import (
    register_net,
...
def make_config() -> Config:
    ...
    register_model()
    register_callbacks()
    # Override/extend callbacks with interactive versions (includes interactive WandB)
    register_callbacks_interactive()
    register_net()
    register_net_teacher()
    register_net_fake_score()
