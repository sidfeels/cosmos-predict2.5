...
from cosmos_predict2._src.predict2_multiview.configs.vid2vid.defaults.callbacks import (
...
def make_config():
    ...
    register_net()
    register_optimizer()
    from cosmos_predict2._src.predict2_multiview.configs.vid2vid.defaults.local_dataloader import (
